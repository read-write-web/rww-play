...
//    val resourceGraphTry = namedResource match {
//      case ldpr: LDPR[Rdf] => Success(PointedGraph(ldpr.location,ldpr.graph))
//      case other => other.meta
//    }
//
//    resourceGraphTry.toOption.toList.flatMap { tg =>
//      for (tp <- tg / rdf.typ) yield {
//        tp.pointer match {
//          // here we select on various types of resources
